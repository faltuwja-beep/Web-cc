...
const JWT_SECRET =
  process.env.JWT_SECRET || "xenon-shop-secret-change-this";
...
app.post(
  ...
  (req, res) => {
    ...
    /*
      ...
      admin ke product me jo
      deliveryContent hoga,
      buy ke baad wahi milega.
    */
...
app.post(
  ...
  (req, res) => {
    ...
    /*
      YAHI PRODUCT KA
      DELIVERY CONTENT HAI.

      Example:

      Free Fire ID details
      Email/password
